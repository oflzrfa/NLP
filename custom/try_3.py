...
# 3. Train the VAE
vae.fit(padded_sequences, epochs=10, batch_size=32)


def generate_text(encoder, decoder, start_string, generation_length=10):
...
print(generate_text(encoder, decoder, start_string, generation_length=100))
